...
},
{
  ...
  return (
    ...
    <Box sx={{ width: '100%',backgroundImage:
     `url(${"https://images.unsplash.com/photo-1554284126-aa88f22d8b74?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1300&q=500"}` }}>
